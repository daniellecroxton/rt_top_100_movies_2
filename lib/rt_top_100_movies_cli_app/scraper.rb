...
class RtTop100MoviesCliApp::Scraper
  ...
  def self.scrape_movie(details_url)
    ...
    details_page.css('#mainColumn').each do | detail |
      ...
      movie_details[:release_date] = detail.css("div.panel-body ul.content-meta li .meta-value")[4].text.strip
      movie_details[:genre] = detail.css("div.panel-body ul.content-meta li .meta-value")[1].text.strip
